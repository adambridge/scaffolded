...
class CallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create call" do
    assert_difference("Call.count") do
      post calls_url, params: { call: { coach_id: @call.coach_id, notes: @call.notes, satisfaction: @call.satisfaction, start: @call.start, student_id: @call.student_id } }
    end
  ...
  test "should update call" do
    patch call_url(@call), params: { call: { coach_id: @call.coach_id, notes: @call.notes, satisfaction: @call.satisfaction, start: @call.start, student_id: @call.student_id } }
